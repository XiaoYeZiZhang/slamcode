...
public:
  ...
  // 这里seed_converged_cb是个function,参数是深度收敛的地图点和对应的方差
  // 对应frame_handler_mono.cpp initialize函数中的point_candidates_  而point_candidates_是MapPointCandidates类，
  // 里面有PointCandidate和PointCandidate的list
  DepthFilter(
